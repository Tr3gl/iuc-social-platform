        ...
        <div className="card p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <RatingSelector
                label={t('grading_fairness')}
                value={formData.grading_fairness}
                onChange={(val) => setFormData({ ...formData, grading_fairness: val })}
                description={METRIC_DESCRIPTIONS.grading_fairness}
              />
